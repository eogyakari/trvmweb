...
export default async function Page() {
  ...
  const title = s['prog_missions_title'] || 'Missions'
  const subtitle = s['prog_missions_subtitle'] || ''
  const content = s['prog_missions_content'] || ''
  const photo = s['prog_missions_photo'] || ''

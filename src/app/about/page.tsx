    ...
    <>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 56, alignItems: 'center' }}>
          ...
          <div style={{ position: 'relative' }}>
            <div style={{
              ...
              border: '3px solid #F5A623', background: 'linear-gradient(135deg, #1A0A2E, #0D0D1A)',
              display: 'flex', alignItems: 'center', justifyContent: 'center'
            }}>
              {s.about_story_photo ? (
                <img src={s.about_story_photo} alt="Our Story"
            ...
            <div style={{
              ...
              <p style={{ fontSize: 13, fontWeight: 800, color: '#0D0D1A' }}>{s.about_leader_name || 'Eugene Owusu Gyakari'}</p>
              <p style={{ fontSize: 11, color: '#0D0D1A', marginTop: 2 }}>{s.about_leader_title || 'Founder & Head of Missions'}</p>
            </div>
          </div>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'inline-block', maxWidth: 320 }}>
            <div style={{
              ...
              <div style={{
                height: 300, background: 'linear-gradient(135deg, #1A0A2E, #0D0D1A)',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                borderBottom: '2px solid #F5A623', overflow: 'hidden'
              }}>
                {s.about_leader_photo ? (
                  <img src={s.about_leader_photo} alt={s.about_leader_name || ''}
                    style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                ) : (
              ...
              <div style={{ padding: '24px 20px' }}>
                <h3 style={{ fontWeight: 800, color: 'white', fontSize: '1.1rem' }}>{s.about_leader_name || 'Eugene Owusu Gyakari'}</h3>
                <p style={{ color: '#F5A623', fontSize: 13, marginTop: 6, fontWeight: 600 }}>{s.about_leader_title || 'Founder & Head of Missions'}</p>
                {s.about_leader_bio && (
                  <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 13, marginTop: 12, lineHeight: 1.7 }}>{s.about_leader_bio}</p>
                )}
              </div>
            </div>
          </div>
      ...
      <section style={{
        ...
        <a href="/contact" style={{
          background: 'white', color: '#7B2FBE', padding: '14px 36px', borderRadius: 30,
          fontSize: 14, fontWeight: 800, letterSpacing: 1, display: 'inline-block', textDecoration: 'none'
        }}>GET IN TOUCH</a>
      </section>
    </>
  )

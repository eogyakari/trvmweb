        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 40, marginBottom: 40 }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              <a href="https://whatsapp.com/channel/0029Va8tSmMJ93wYZHZvZk1C" target="_blank" style={{ color: "#a0a0b0", fontSize: 13 }}>WhatsApp Channel</a>
            </div>
          </div>
        </div>

        <div style={{ borderTop: "1px solid rgba(123, 47, 190, 0.2)", paddingTop: 24, textAlign: "center" }}>
